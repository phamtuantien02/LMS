...
@Component({
  selector: 'app-slidenetcore',
  templateUrl: './slidenetcore.component.html',
  styleUrls: ['./slidenetcore.component.css']
})
export class slidenetcoreComponent implements OnInit{
