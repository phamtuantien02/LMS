...
@Component({
  selector: 'app-slidesql',
  templateUrl: './slidesql.component.html',
  styleUrls: ['./slidesql.component.css']
})
export class slidesqlComponent implements OnInit{
